if (typeof jQuery === "undefined") {
    ...
    b.prototype.backdrop = function(i) {
        ...
        if (this.isShown && this.options.backdrop) {
            ...
            this.$element.on("mousedown.dismiss.bs.modal", d.proxy(function(j) {
    ...
    c.prototype.getPosition = function(g) {
        ...
        var h = typeof i.getBoundingClientRect == "function" ? i.getBoundingClientRect() : null;
        var l = f ? {
            top: 0,
            left: 0
        } : g.offset();
        ...
        var j = k ? {} : {
            width: f ? d(window).width() : g.outerWidth(),
            height: f ? d(window).height() : g.outerHeight()
        };
    ...
    b.prototype.activate = function(g, f, j) {
        var e = f.find("> .active");
        var i = j && d.support.transition && ((e.length && e.hasClass("fade")) || !!f.find("> .fade").length);
        ...
        e.length && i ? e.one("bsTransitionEnd", h).emulateTransitionEnd(150) : h();
        e.removeClass("in")
    };
    ...
    c(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function(k) {
        ...
        if (!i || !i.transitioning) {
            ...
            m.toggleClass("collapsed", g.hasClass("in"))
        }
        b.call(g, j)
    })
}(jQuery); + function(d) {
